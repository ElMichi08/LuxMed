...
from app.application.dto import ResumenLote, SeleccionEntregables
...
class DeliverablesDialog(QDialog):
    ...
    def __init__(
        ...
        self._casilla_auditado, fila_auditado = self._crear_fila_entregable(
            ...
            f"{resumen.procesados} filas · {resumen.filas_en_rojo} en rojo",
        )
        ...
        boton_cancelar.setProperty("variante", "secundario")
        ...
        disposicion_pie.addWidget(boton_cancelar)
    ...
    def _crear_cabecera(self, resumen: ResumenLote) -> QFrame:
        ...
        subtitulo = QLabel(
            f"Lote {resumen.cabecera.lote_id} · {resumen.cabecera.total_filas} pacientes"
        )
